...
def main():
    ...
    # Import from combined_dataset as well
    combined_datasets = [
        ('combined_dataset/uniform_1/train', 'compliant'),
        ('combined_dataset/uniform_1/valid', 'compliant'),
        ('combined_dataset/uniform_1/test', 'non-compliant'),
        ('combined_dataset/uniform_2/train', 'compliant'),
        ('combined_dataset/uniform_2/valid', 'compliant'),
        ('combined_dataset/uniform_2/test', 'non-compliant'),
    ]

    for folder, label in combined_datasets:
        if os.path.exists(folder):
            imported = import_dataset_folder(folder, label, cfg)
            total_imported += imported
